...
const __KEY = "AIzaSyCb1IUjV_JUZq4KUe08aa1o0KSyUtWXpsg";
...
populateCard = (geoResults) => {
 ...
 // removeAddressCards();
  ...
  geoResults.map(geoResult => {
    ...
    document.getElementById('gadget_url').value = geoResult.formatted_address;

    // // first create the input div container
    // const addressCard = document.createElement('div');

    // // then create the input and label elements
    // const input = document.getElementsByName('location');
